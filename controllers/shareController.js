...
const shareTest = async (req, res) => {
    ...
    const initialText = `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><meta property="og:type" content="article"/><meta property="og:url" content="https://los11metros.onrender.com/share/${post}"/><meta property="og:title" content="${title}"/><meta property="og:description" content="${heading}"/><meta property="og:image" content="${thumbnail}"/></head><body></body></html>`
    try {
